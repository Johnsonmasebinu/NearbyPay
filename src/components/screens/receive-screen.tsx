    ...
    <View style={[styles.container, { backgroundColor: t.pageBg }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.qrCardContainer}>
          ...
          <View style={styles.cardActionsRow}>
            <TouchableOpacity
              ...
              <Text style={styles.cardActionText}>Download QR</Text>
            </TouchableOpacity>
        ...
        <View style={[styles.linkBox, { backgroundColor: t.cardBg, borderColor: t.cardBorder }]}>
          <HugeiconsIcon icon={Link01Icon} size={18} color="#2563EB" />
        ...
        {/* Info Banner Card */}
        <TouchableOpacity
          style={[styles.infoBanner, { backgroundColor: isDark ? '#0F172A' : '#EFF6FF', borderColor: isDark ? '#1E293B' : '#DBEAFE' }]}
          activeOpacity={0.85}
          ...
          <HugeiconsIcon icon={ArrowRight01Icon} size={18} color="#2563EB" />
        </TouchableOpacity>
