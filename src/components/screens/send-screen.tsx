    ...
    <View style={[styles.container, { backgroundColor: t.pageBg }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View
          style={[
            styles.searchBar,
            { backgroundColor: t.cardBg, borderColor: focused === 'search' ? '#2B20F0' : t.cardBorder },
          ]}>
        ...
        <TouchableOpacity
          ...
          <View style={styles.bankLeft}>
            <View style={styles.bankIconCircle}>
              <HugeiconsIcon icon={Building01Icon} size={18} color="#2563EB" />
            </View>
        ...
        <View
          style={[
            styles.amountCard,
            { backgroundColor: t.cardBg, borderColor: focused === 'amount' ? '#2B20F0' : t.cardBorder },
          ]}>
        ...
        <View
          style={[
            styles.noteCard,
            { backgroundColor: t.cardBg, borderColor: focused === 'note' ? '#2B20F0' : t.cardBorder },
          ]}>
          <TextInput
        ...
        {/* Security Banner */}
        <View style={[styles.securityCard, { backgroundColor: isDark ? '#0F172A' : '#EFF6FF', borderColor: isDark ? '#1E293B' : '#DBEAFE' }]}>
          <View style={styles.securityIconCircle}>
            <HugeiconsIcon icon={ShieldCheckIcon} size={20} color="#2563EB" />
          </View>
